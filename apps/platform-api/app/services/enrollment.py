...
def enroll_application(actor_user_id: int, application_id: int) -> dict[str, Any]:
    with transaction() as connection:
        ...
        member_id = create_member(
            ...
            social_role=row.get("social_role"),
            email=row.get("email"),
            invoice_type=row.get("invoice_type"),
            invoice_title=row.get("invoice_title"),
            invoice_tax_id=row.get("invoice_tax_id"),
            ...
            goal_years=row.get("goal_years"),
            revenue_growth_target=row.get("revenue_growth_target"),
            profit_growth_target=row.get("profit_growth_target"),
