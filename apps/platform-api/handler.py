...
try:
    ...
    # The serverless adapter keeps one ASGI client alive across warm invocations
    # so the MCP Streamable HTTP session manager receives its application
    # lifespan and can serve stateful MCP sessions.
    client.__enter__()
