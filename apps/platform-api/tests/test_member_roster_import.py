...
def test_preview_is_aggregate_only_and_identifies_existing_and_new_members() -> None:
    ...
    content = _workbook_bytes([
        ["0001", "在册", "已存在学员", "男", "总经理", "1980-01-02", "15500001000", "导入测试分中心", "导入测试班", "一号班组委", "导入测试组", "测试公司", "2020-01-02", "2020-02-01", "推荐人", "10人", "2026-11-01"],
        ["0002", "在册", "新增学员", "女", "经理", "1985-03-04", "15500001001", "导入测试分中心", "导入测试班", "二号班组委", "导入测试组", "新增公司", "2021-03-04", "2021-04-01", "推荐人2", "8人", "2026-12-01"],
    ])
...
def test_apply_only_fills_missing_fields_and_adds_committee_name() -> None:
    ...
    content = _workbook_bytes([
        ["0003", "在册", "待补充学员", "男", "董事", "1981-01-02", "15500001002", "导入测试分中心", "导入测试班", "班组委A", "导入测试组", "新公司不覆盖", "2020-01-02", "2020-02-01", "推荐人", "12人", "2026-11-01"],
    ])
