...
VALUES
    ('staff:manage', '管理普通专职人员', 'SENSITIVE', CURRENT_TIMESTAMP),
    ('enrollment:unassigned_review', '查看未分配组织的入塾申请', 'SENSITIVE', CURRENT_TIMESTAMP);
...
SELECT oi.id, ou.id, 'LEGACY_REPRESENTATION', CURRENT_TIMESTAMP
